...
# Project Rules: Flutter Clean Architecture & Agent Teams

## Agent Team Roles
- **@Architect:** Lead. Oversees Clean Architecture and project structure.
- **@LogicDev:** Domain & Data specialist. Handles Firebase, Repositories, and Providers.
- **@UIDev:** Presentation specialist. Handles Widgets, Screens, and input validation.
- **@QAEngineer:** Testing specialist. Manages unit/integration tests and code quality.

## Tech Stack & Standards
- **Architecture:** Clean Architecture (Data, Domain, Presentation).
- **State Management:** Riverpod.
- **Naming:** camelCase for variables/methods, PascalCase for classes.
- **Testing:** Integration tests must be modular (per feature).
